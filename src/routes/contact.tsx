      ...
      <section className="max-w-6xl mx-auto px-4 py-12 grid lg:grid-cols-5 gap-8">
        <div className="lg:col-span-2 space-y-4">
          {[
            ...
            <div key={c.t} className="bg-card border border-border rounded-xl p-5 flex gap-4">
        ...
        <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="lg:col-span-3 bg-card border border-border rounded-xl p-6 space-y-4">
          {sent ? (
